...
def test_builtin_compaction_event_family():
    ...
    start = CompactionStartEvent(strategy='summarize', message_count=12, estimated_tokens=40_000)
    ...
    end = CompactionEndEvent(strategy='summarize', messages_before=12, messages_after=3, tokens_before=40_000)
